...
### 代理店インセンティブ管理機能
- **案件ベースのインセンティブ登録**: プロジェクトごとにインセンティブ設定を登録
- **インセンティブ種類**: パーセント型または固定金額型を選択可能
- **対象代理店指定**: 特定代理店または全代理店対象を選択
- **期間設定**: 開始日・終了日によるインセンティブ期間管理
- **ステータス管理**: 有効/無効/終了の切り替え
- 新規データベーステーブル: agency_incentives

### スタッフ詳細ページの4タブ機能
- **タスクタブ**: スタッフに割り当てられたタスク一覧とエビデンス提出機能
- **アフィリエイトタブ**: アフィリエイトリンク管理とパフォーマンス追跡（クリック数、成約数、収益）
- **システムタブ**: 給与システム設定の表示（基本給、入社日、社員番号、締め日、支払日）
- **メモタブ**: スタッフ関連メモの管理（カテゴリ: 一般、パフォーマンス、フィードバック、目標、その他）
...
- **削除機能**: ノードをクリックして選択→削除ボタンで削除
- **全画面表示**: 図面を全画面で表示して作業可能
...
### スタッフ詳細ページの4つの新タブ追加
- **タスクタブ**: スタッフに割り当てられたタスク一覧表示、エビデンス提出機能（ファイルアップロード、説明追加）
- **アフィリエイトタブ**: アフィリエイトリンク管理、パフォーマンス追跡（クリック数、成約数、収益）
- **システムタブ**: 給与システム設定の表示（基本給、入社日、社員番号、締め日、支払日、銀行口座情報）
- **メモタブ**: スタッフ関連メモの管理（カテゴリ: 一般、パフォーマンス、フィードバック、目標、その他）
- 新規データベーステーブル: task_evidence, staff_affiliates, staff_memos
- エビデンスはファイルまたはリンクで提出可能
- アフィリエイトはプラットフォーム、URL、コード、コミッション率を記録
