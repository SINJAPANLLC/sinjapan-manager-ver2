...
export function Layout({ children }: LayoutProps) {
  ...
  const allMenuItems = [
    { href: '/', label: 'ホーム', icon: Home, roles: ['admin', 'ceo', 'manager'] },
    { href: '/tasks', label: 'タスク', icon: ClipboardList, roles: ['admin', 'ceo', 'manager'] },
    ...
    { href: '/ai', label: 'AI', icon: Bot, roles: ['admin', 'ceo', 'manager'] },
    { href: '/staff', label: 'スタッフ', icon: UserCheck, roles: ['admin', 'ceo', 'manager', 'staff'] },
